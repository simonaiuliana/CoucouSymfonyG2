 ...
 */
final class Version20240920111637 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD post_id INT UNSIGNED NOT NULL, ADD user_id INT UNSIGNED NOT NULL');
