 ...
 */
final class Version20240920124721 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD post_id INT UNSIGNED NOT NULL, ADD user_id INT UNSIGNED NOT NULL, ADD comment_published TINYINT(1) DEFAULT 0 NOT NULL');
